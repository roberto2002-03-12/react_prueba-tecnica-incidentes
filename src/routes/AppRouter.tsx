...
export const AppRouter = () => {
  ...
  const localUser: IUser = localStorage.getItem('user') === null ? undefined : JSON.parse(localStorage.getItem('user')!)
    ...
    <Routes>
      {
        authLocal === 'authenticated' ? (
          <>
            ...
            {
              (localUser && localUser.role === undefined) || (localUser && localUser.role && localUser.role.length === 0) ?
                <>
